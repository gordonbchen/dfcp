...
DEFAULT_OBSERVED = DATA_DIR / "dfcp_prep/target_masked.observed_loci.txt"
...
def write_report(
    ...
    default_windows = min(100, maximum_windows)
...
<input id="n-windows-number" type="number" min="1" max="{maximum_windows}" value="{default_windows}">
</div><input id="n-windows-range" type="range" min="1" max="{maximum_windows}" value="{default_windows}">
