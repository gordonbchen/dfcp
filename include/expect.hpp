...
double ll_log_alpha(double log_alpha, const HyperParams& HP, const Params& params, const TClusters& clusters) {
...
template <typename TClusters>
double ll_log_alpha_d2(double alpha, const HyperParams& HP, const Params& params, const TClusters& clusters) {
...
template <typename TClusters>
double ll_logit_dl(double logit_dl, int l, const HyperParams& HP, const Params& params, const TClusters& clusters) {
...
template <typename TClusters>
double ll_logit_dl_d2(double d, int l, const HyperParams& HP, const Params& params, const TClusters& clusters) {
    int nQl = clusters.qs[l].size();
    int nRl1 = clusters.rs[l].size() + clusters.rs[l+1].size();
...
template <typename TClusters>
void expect_step(const HyperParams& HP, Params& params, const TClusters& clusters) {
    // alpha update.
    laplace_log_approx(
